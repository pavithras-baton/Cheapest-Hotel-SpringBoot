...
public class ReservationServiceTest {
    ...
    public void makeReservation_regularcustomer() {
        ...
        expensiveHotel.setRegularWeekdayPrice(500.0);

        Hotel cheapHotel = new Hotel();
        cheapHotel.setName("Cheap");
        cheapHotel.setTotalRooms(5);
        cheapHotel.setRegularWeekdayPrice(100.0);
    ...
    public void makeReservation_rewardscustomer() {
        ...
        hotel.setRegularWeekdayPrice(500.0); // Very expensive for regular
        hotel.setRewardWeekdayPrice(50.0);   // Very cheap for rewards
